...
We obtain consistent results when fitting only the small- or large-$x$ regions, justifying our approximation of constant $G(x) = c_G$. % How small is small-x and how large is large-x? --DS
...
PS,V	&	4.0	& 	1.xx	&	 -0.xx 	&	xx	&	1	&	xxx	\\
	...
	&	5.0	&		&			&	xx	&	xx	&	\\	
%\hline
%PS	&	4.0,4.5,5.0	& 		&	 as above 	&	xx	&	1	&	xxx	\\
